...
# %%
facttable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.fact_cicsiltest2"
dimtable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_cicsiltest2"
