...
# %%
sq = """ 
create or replace table prj-prod-dataplatform.dap_ds_poweruser_playground.fact_siltrain2 as 
select * from 
(select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_cicsiltrain2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_alphastacksil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_appscoresil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betademosil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betastacksil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_credosil_train2
)
"""
...
# %%
sq = """ 
create or replace table prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_siltrain2 as 
select * from 
(select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_cicsiltrain2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_alphastacksil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_appscoresil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betademosil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betastacksil_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_credosil_train2
)
"""
