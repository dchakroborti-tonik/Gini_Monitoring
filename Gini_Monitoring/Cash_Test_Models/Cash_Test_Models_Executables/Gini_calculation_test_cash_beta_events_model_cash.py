...
# %% [markdown]
# #### beta_events_model_cash

# %%

facttable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betaeventcash_test2"
dimtable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betaeventcash_test2"
...
-- ,
  ...
  start_time,
  prediction,
  -- coalesce(p.trenchCategory, JSON_VALUE(m.requestPayload_clean, "$.predictions.trenchCategory")) AS 
  p.trenchCategory,
  case when modelDisplayName like 'beta_events_model_cash' then 'beta_events_model_cash' else p.modelDisplayName end as modelDisplayName,
...
print("Gini Calculation for beta_events_model_cash for FPD0 started")
# %%
...
df_f_fpd0_betaeventcash = fact_table.copy()
df_d_fpd0_betaeventcash = dimension_table.copy()


job_config = bigquery.LoadJobConfig(
    write_disposition="WRITE_TRUNCATE",  # or "WRITE_APPEND"
)
job = client.load_table_from_dataframe(df_f_fpd0_betaeventcash, facttable_id, job_config=job_config)
...
print("Gini Calculation for beta_events_model_cash for FPD0 completed")
...
print("Gini Calculation for beta_events_model_cash for FPD10 started")
# %%
fact_table, dimension_table = calculate_periodic_gini_prod_ver_trench_dimfact(
    df_concat,
    "prediction",
...
df_f_fpd10_betaeventcash = fact_table.copy()
df_d_fpd10_betaeventcash = dimension_table.copy()

job_config = bigquery.LoadJobConfig(
    write_disposition="WRITE_APPEND",  # or "WRITE_APPEND"
)
job = client.load_table_from_dataframe(df_f_fpd10_betaeventcash, facttable_id, job_config=job_config)
job.result()  # Wait for the job to complete
...
# %%
print("Gini Calculation for beta_events_model_cash for FPD10 completed")
...
print("Gini Calculation for beta_events_model_cash for FPD30 started")
# %%
fact_table, dimension_table = calculate_periodic_gini_prod_ver_trench_dimfact(
    df_concat,
    "prediction",
...
df_f_fpd30_betaeventcash = fact_table.copy()
df_d_fpd30_betaeventcash = dimension_table.copy()

job_config = bigquery.LoadJobConfig(
    write_disposition="WRITE_APPEND",  # or "WRITE_APPEND"
)
job = client.load_table_from_dataframe(df_f_fpd30_betaeventcash, facttable_id, job_config=job_config)
job.result()  # Wait for the job to complete
...
print("Gini Calculation for beta_events_model_cash for FPD30 completed")
...
print("Gini Calculation for beta_events_model_cash for FSPD30 started")
# %%
fact_table, dimension_table = calculate_periodic_gini_prod_ver_trench_dimfact(
    df_concat,
    "prediction",
...
# %%
df_f_fspd30_betaeventcash = fact_table.copy()
df_d_fspd30_betaeventcash = dimension_table.copy()

job_config = bigquery.LoadJobConfig(
    write_disposition="WRITE_APPEND",  # or "WRITE_APPEND"
)
job = client.load_table_from_dataframe(df_f_fspd30_betaeventcash, facttable_id, job_config=job_config)
job.result()  # Wait for the job to complete
...
job = client.load_table_from_dataframe(
    df_d_fspd30_betaeventcash, dimtable_id, job_config=job_config
)
job.result()  # Wait for the job to complete

# %%
print("Gini Calculation for beta_events_model_cash for FSPD30 completed")
