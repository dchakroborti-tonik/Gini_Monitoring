...
facttable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.fact_appscorecash_test2"
dimtable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_appscorecash_test2"
...
-- ,
  ...
  p.modelVersionId,
  -- coalesce(p.trenchCategory, JSON_VALUE(m.requestPayload_clean, "$.predictions.trenchCategory"))  
  p.trenchCategory, 
  osType
...
job = client.load_table_from_dataframe(df_f_fpd0_appscorecash, facttable_id, job_config=job_config)
