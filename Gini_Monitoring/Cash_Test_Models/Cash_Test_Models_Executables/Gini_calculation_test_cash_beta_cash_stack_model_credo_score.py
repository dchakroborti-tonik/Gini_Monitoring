...
# %%
# %%
facttable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betacredocash_test2"
dimtable_id = "prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betacredocash_test2"
