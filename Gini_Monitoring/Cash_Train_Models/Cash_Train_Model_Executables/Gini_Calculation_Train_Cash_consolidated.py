...
# %% [markdown]
# ## 💻 Creating the consolidated fact and dimension table
...
# %%
sq = """ 
create or replace table prj-prod-dataplatform.dap_ds_poweruser_playground.fact_cashtrain2 as 
select * from 
(select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_alphaciccash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_alphastackcash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betacredocash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_appscorecash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betademocash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betastackcash_train2
union all 
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.fact_betaeventcash_train2
)
"""
...
# %% [markdown]
# ### ❄️ Dimension Table combined

# %%
sq = """ 
create or replace table prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_cashtrain2 as 
select * from 
(select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_alphaciccash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_alphastackcash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betacredocash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_appscorecash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betademocash_train2
union all
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betastackcash_train2
union all 
select * from prj-prod-dataplatform.dap_ds_poweruser_playground.dimension_betaeventcash_train2
)
"""
